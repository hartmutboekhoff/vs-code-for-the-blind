...
class SimplePageConfigEditor extends SiteConfigEditor {

	constructor(context, document, webviewPanel, token) {
	  super(context, document, webviewPanel, 'SimplePageConfigEditorViews', '../config/schema/any-page.schema.json', token);
  }
...
module.exports = SimplePageConfigEditor;